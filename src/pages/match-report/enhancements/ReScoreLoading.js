...
const TIPS = [
  "Tip: Re-scoring evaluates your edited resume against the same job requirements.",
  "Tip: Changes to keywords and skills can significantly impact your match score.",
  "Tip: Suggestions will be refreshed based on your updated resume content.",
  "Tip: Focus on high-impact sections like skills and experience for the best results.",
];

const ReScoreLoading = () => {
  const [visibleSteps, setVisibleSteps] = useState(0);
  const [currentTip, setCurrentTip] = useState(0);

  useEffect(() => {
    const timers = RESCORE_STEPS.map((step, index) =>
