...
const ApplicationSuccess = () => {
    ...
    return (
        <div className="relative min-h-[90vh] flex items-center justify-center bg-[#FCFCFD] overflow-hidden p-6 font-body">
            {/* Background Decor tương đồng với trang Pending */}
            ...
            <Card className="relative z-10 max-w-lg w-full !p-12 border border-neutral-100 bg-white/80 backdrop-blur-md shadow-[0_20px_50px_rgba(255,107,53,0.12)]">
                <div className="text-center">
                    {/* Icon Section với hiệu ứng nhịp thở (Ping) */}
                    ...
                    <div className="space-y-4 text-neutral-600 leading-relaxed">
                        ...
                        <p className="text-sm px-4">
                            The recruiter at <span className="text-primary font-bold">Techcombank</span> has received your profile and resume.
                    ...
                    <div className="mt-10 space-y-4">
                        <Button
                            ...
                            fullWidth
                            size="lg"
                            className="shadow-xl shadow-orange-100 italic"
